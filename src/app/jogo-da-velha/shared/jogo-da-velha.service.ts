...
export class JogoDaVelhaService {
  ...
  /**
   * Retorna se a tabela fim de jogo deve ser exibida
   *
   * @return boolean
   */
  get mostrarFinal(): boolean {
    return this._mostrarFinal
  }
  ...
  /**
   * Obtém uma jogada válida para vitória de um jogodor
   *
   * @param number jogador
   * @return number[]
   */
